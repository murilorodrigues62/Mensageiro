...
//        startService(serviceIntent); 
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                // Abre a tela de mensagens ao clicar na lista
                Contato c = (Contato)parent.getItemAtPosition(position);
                Intent intent = new Intent(ContatosActivity.this, MensagemActivity.class);
                intent.putExtra("id_destino",c.getId());
                            ...
                            for(int i=0;i<contatos.length();i++){
                                ...
                                Collections.sort(listContatos, new Comparator<Contato>() {
                                    ...
                                    public int compare(Contato contato, Contato t1) {
                                        return contato.getNome().toLowerCase().compareTo(t1.getNome().toLowerCase());
                                    }
                                });
